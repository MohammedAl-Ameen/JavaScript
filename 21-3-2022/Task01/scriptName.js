...
document.getElementById('arrays').innerHTML = phone + "<br>";
document.getElementById('arrays').innerHTML += names + "<br>" + animals;
...
*/
var fruits=["Tomato","Banana","Watermelon"]
document.getElementById('index').innerHTML = fruits.indexOf('Tomato') +"<br>";
document.getElementById('index').innerHTML += fruits.indexOf('Banana');
...
foor = ["Monsaf" , "Barger" , "Magloba"];
Sport = ["Gaming", "nothing" , "noting"];
Movie = ["Batman", "Superman" , "tamerman"];
